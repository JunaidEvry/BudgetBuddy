...
<body>
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 " novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <p class="small mb-0">Forgot Password? <a href="forgotPassword.cfm">Please Click here</a></p>
                    </div>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">Don't have an account? <a href="register.cfm">Create an account</a></p>
                    </div>
                  </form>
  ...
  <!-- jQuery (necessary for AJAX calls) -->
